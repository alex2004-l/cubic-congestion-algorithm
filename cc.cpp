...
// Aceasta functie este apelata atunci cand dimensiunea cozii a fost depasita
// iar packetul cu numarul de secventa ackno a fost aruncat.
...
void CCSrc::processAck(const CCAck& ack) {
  ...
  if (ack.is_ecn_marked()) {
    // Atunci cand un packet pleaca pe fir, el va fi marcat ECN doar daca
    // dimensiunea cozii este mai mare decat threshold-ul ECN setat. Receptorul
    // va copia acest marcaj in pachetul ACK. Transmitatorul poate lua in calcul
    // reducerea ratei, ca in exemplul mai jos.
